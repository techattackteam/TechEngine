...
namespace TechEngine {
    ...
    public:
        MeshRendererComponent(GameObject* gameObject, SystemsRegistry& systemsRegistry);

        MeshRendererComponent(GameObject* gameObject, SystemsRegistry& systemsRegistry, Mesh& mesh, Material* material);
