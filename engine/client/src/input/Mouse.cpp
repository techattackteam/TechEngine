...
namespace TechEngine {
    ...
    void Mouse::onUpdate() {
        if (m_buttonsPressed[0]) {
            m_systemsRegistry.getSystem<EventDispatcher>().dispatch(new KeyHoldEvent(Key(MOUSE_1)));
        }
        if (m_buttonsPressed[1]) {
            m_systemsRegistry.getSystem<EventDispatcher>().dispatch(new KeyHoldEvent(Key(MOUSE_2)));
        }
        if (m_buttonsPressed[2]) {
            m_systemsRegistry.getSystem<EventDispatcher>().dispatch(new KeyHoldEvent(Key(MOUSE_3)));
        }
        if (m_buttonsPressed[3]) {
            m_systemsRegistry.getSystem<EventDispatcher>().dispatch(new KeyHoldEvent(Key(MOUSE_4)));
        }
        if (m_buttonsPressed[4]) {
            m_systemsRegistry.getSystem<EventDispatcher>().dispatch(new KeyHoldEvent(Key(MOUSE_5)));
        }
        if (m_buttonsPressed[5]) {
            m_systemsRegistry.getSystem<EventDispatcher>().dispatch(new KeyHoldEvent(Key(MOUSE_6)));
        }
        if (m_buttonsPressed[6]) {
            m_systemsRegistry.getSystem<EventDispatcher>().dispatch(new KeyHoldEvent(Key(MOUSE_7)));
        }
        if (m_buttonsPressed[7]) {
            m_systemsRegistry.getSystem<EventDispatcher>().dispatch(new KeyHoldEvent(Key(MOUSE_8)));
        }
    }
    ...
    void Mouse::onMouseMove(double x, double y) {
        ...
        m_systemsRegistry.getSystem<EventDispatcher>().dispatch(new MouseMoveEvent(fromPosition, toPosition));
