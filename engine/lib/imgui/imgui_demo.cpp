...
// debug menu of your gameEvents/app! Removing this file from your project is hindering access to documentation for everyone
...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Text Input"))
    {
        ...
        {
            // Note: we are using a fixed-sized inBuffer for simplicity here. See ImGuiInputTextFlags_CallbackResize
...
struct ExampleAppLog
{
    ...
    void    Draw(const char* title, bool* p_open = NULL)
    {
        ...
        {
            // The simplest and easy way to display the entire inBuffer:
...
static void ShowExampleAppLongText(bool* p_open)
{
    ...
    {
    case 0:
        // Single call to TextUnformatted() with a big inBuffer
