...
namespace TechEngine {
    ...
    void Core::init(const std::filesystem::path& rootPath, std::unordered_map<ProjectConfig, std::string>& projectConfigs) {
        ...
        m_systemRegistry.getSystem<ScenesManager>().init(appType, projectConfigs);
    }
